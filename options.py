...
def read_options():
    ...
    parser.add_argument("--meta_train_file", default="meta_train.json", type=str)
    parser.add_argument("--meta_dev_file", default="meta_dev.json", type=str)
    parser.add_argument("--meta_test_file", default="meta_test.json", type=str)
    parser.add_argument("--few_shot_file", default="few_shot.json", type=str)
