...
def read_options():
    ...
    parser.add_argument("--dev_file", default="meta_test.json", type=str)
    parser.add_argument("--meta_dev_file", default="meta_test.json", type=str)
    parser.add_argument("--meta_step", default=10, type=int)
    parser.add_argument("--few_shot_dev_file", default="few_shot_test.json", type=str)
    parser.add_argument("--few_shot_size", default=5, type=int)
