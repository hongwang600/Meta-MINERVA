...
def read_options():
    ...
    parser.add_argument("--test_rollouts", default=50, type=int)
    parser.add_argument("--policy_layers", default=3, type=int)
    parser.add_argument("--model_dir", default='', type=str)
    parser.add_argument("--base_output_dir", default='', type=str)
    parser.add_argument("--total_iterations", default=3000, type=int)
